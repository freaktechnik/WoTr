...
<html xmlns="http://www.w3.org/1999/xhtml" lang="de" dir="ltr" xml:lang="de">
  <head>
    ...
    <script src="franz.js" type="text/javascript">
</script>
    ...
    <style type="text/css">
    /*<![CDATA[*/
    #pw {   width:156px;}#username {        width: 100%;}
    /*]]>*/
    </style>
  </head>
  <body>
    <div id="wrapper">
      <div id="nav">
        ...
        <table id="usertbl">
          <tr>
            ...
            <td class="active">
              <a href="userdata.php" id="unm" name="unm"></a>
            </td>
          </tr>
        </table>
      </div>
      ...
      <div id="content">
        ...
        New password: <input type="password" id="password" class="textf" /> Proof the password: <input type="password" id="passwordpr" class="textf" />
        <div class="buttons" id="save">
          Save
        </div>
        <div id="stay">
          <b>Stay logged in</b>
          <div class="buttons" id="delete">
            Delete
          </div>
        </div>
        <div id="resultwrap">
